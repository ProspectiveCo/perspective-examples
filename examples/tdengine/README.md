# TDengine <> Perspective - Real-time Data Analysis and Visualization for IIoT time-series Applications
...
This document explains how to configure Perspective with a TDengine for high-performance real-time IIoT time-series applications. 
